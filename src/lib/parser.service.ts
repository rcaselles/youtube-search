    ...
    try {
      ...
      if (data.videoRenderer) {
        ...
        const descripcionAux = () => {
          try {
            data.videoRenderer.detailedMetadataSnippets[0].snippetText.runs.map((c: any, i: number) => {
        ...
        return {
          ...
          title,
          channelName:
            data.videoRenderer.longBylineText && data.videoRenderer.longBylineText.runs[0]
              ? data.videoRenderer.longBylineText.runs[0].text
              : null,
          ...
          snippet: {
            ...
            thumbnails: {
              ...
              height:
                data.videoRenderer.thumbnail.thumbnails[data.videoRenderer.thumbnail.thumbnails.length - 1].height,
